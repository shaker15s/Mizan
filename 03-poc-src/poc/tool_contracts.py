...
_TOOL_CONTRACTS: dict[str, dict[str, Any]] = {
    "customer.search": _contract(
        ...
        odoo={
            ...
            "fields": ["id", "name", "email", "phone", "street", "city", "credit_limit"],
            "limit_cap": 20,
        },
    ),
    "customer.get": _contract(
        ...
        odoo={
            "model": "res.partner",
            "method": "read",
            "fields": ["id", "name", "email", "phone", "street", "city", "credit_limit", "vat"],
        },
    ),
    ...
    "sales.order.get": _contract(
            ...
            "properties": {
                ...
                "order": {
                    ...
                    "properties": {
                        ...
                        "state": {"type": "string"},
                        "amount_total": {"type": "number"},
                        "amount_untaxed": {"type": ["number", "null"]},
                        "date_order": {"type": ["string", "null"]},
                        "client_order_ref": {"type": ["string", "null"]},
                    },
                },
            },
        },
        odoo={
            "model": "sale.order",
            "method": "read",
            "fields": ["id", "name", "partner_id", "state", "amount_total", "amount_untaxed", "date_order", "client_order_ref"],
        },
    ),
}
