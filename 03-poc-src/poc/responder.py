        ...
        if outcome == "text_only":
            ...
            code_map = {
                ...
                "decision_quarantined": (
                    "تحويل لمراجعة أمنية",
                    "إشارة القرار كشفت محاولة للتأثير على النظام، فالمسار اتوقف قبل أي تنفيذ — مفيش أي عملية وصلت لـ Odoo.",
                    "DECISION_QUARANTINED",
                    False,
                    [
                        "الحجر إجراء أمني إضافي فقط: السياسة الحتمية هي اللي تقرر التفويض دايمًا.",
                        "لو الطلب شرعي، أعد صياغته كطلب عمل واضح (عميل/منتج/كمية) بدون أي تعليمات للنظام.",
                        "الحادثة مسجّلة في سلسلة الأدلة بصمةً للحالة وإشارة النموذج — بدون أي بيانات سرية.",
                    ],
                ),
                "decision_clarification": (
                    "محتاج توضيح",
                    "نية الطلب غير واضحة بالقدر الكافي لتنفيذ عملية كتابة — فمفيش مقترح اتعمل ولا أي حاجة اتنفذت.",
                    "DECISION_CLARIFICATION",
                    True,
                    [
                        "حدّد بدقة: اسم أو رقم العميل، والمنتج، والكمية المطلوبة.",
                        "الإشارة استشارية: الخادم هو اللي يقرر ينفّذ ولا لأ، والكتابة دايمًا محتاجة توقيعك.",
                    ],
                ),
                "in_progress": (
                    "العملية لسه شغالة",
